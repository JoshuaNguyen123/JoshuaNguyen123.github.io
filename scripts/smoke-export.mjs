...
for (const expected of ["Joshua Nguyen", "FDE, AI developer, and technical researcher.", "I like solving problems—technically and operationally.", "Build Index", "Selected work", "Obsidian Research Agent", "not productivity", "Codex active session-days", "Claude active session-days", "Cursor active session-days", "Cursor applied AI line changes", "Observed activity", "Usage evidence"]) {
